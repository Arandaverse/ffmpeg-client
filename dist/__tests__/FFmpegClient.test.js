...
const FFmpegClient_1 = require("../FFmpegClient");
describe("FFMPEGClient", () => {
    ...
    beforeEach(() => {
        ...
        client = new FFmpegClient_1.FFMPEGClient("http://api.example.com", "test-api-token");
    });
    ...
    it("should check job status", async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith("http://api.example.com/ffmpeg/progress/123", {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "X-API-Token": "test-api-token",
